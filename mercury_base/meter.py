...
class Meter(object):
    ...
    def command(self, command, *params):
        ...
        data = command_method(self, *params)
        return data
    ...
    def send_package(self, package: bytes, attempts=3):
        ...
        while not answer and attempts:
            ...
            if self.__logger:
                self.__logger.debug('--> [%s]\t%s', self.__serial_number, hex_str(package, ' '))
            time.sleep(0.1)
